...
{
  volatile float Lp;				// Setpoint lowpass
 ...
 */
inline void CTRL_Init(float Ka, float Kp, float Tn, float Td, float T, float Lp, float maxIn, float maxOut, CTRL_t* ctrl);
